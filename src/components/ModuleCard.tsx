...
const ModuleCard: React.FC<ModuleCardProps> = ({ id, title, description, status, onClick }) => {
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <div className={`
          ...
          ${isLocked ? 'bg-gray-700' : isCompleted ? 'bg-green-500' : 'bg-git-orange'}
        `}>
      ...
      {!isLocked && (
        <div className={`text-xs font-bold uppercase tracking-wider flex items-center ${isCompleted ? 'text-green-400' : 'text-git-orange'}`}>
